...
<div class="d-flex alokasi-wrapper">
  ...
  <div class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="alokasi-content shadow flex-grow-1">
      <a href="<?= base_url('/admin/alokasiwaktu/create') ?>" class="btn btn-primary mb-3">
          ...
          <tbody>
            <?php $no = 1; foreach ($alokasi as $a): ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url('admin/alokasiwaktu/edit/' . $a['id']) ?>" class="btn btn-sm btn-warning">Edit</a>
                  <form action="<?= base_url('admin/alokasiwaktu/delete/' . $a['id']) ?>" method="post" style="display:inline;" onsubmit="return confirm('Yakin hapus alokasi ini?');">
                    <?= csrf_field() ?>
