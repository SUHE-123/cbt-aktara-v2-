...
<div class="d-flex sekolah-index-wrapper">
  ...
  <div class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="flex-grow-1 sekolah-index-content shadow">
      <a href="<?= base_url('/admin/jadwalujian/create') ?>" class="btn btn-primary mb-3">
        ...
        <tbody>
          <?php $no = 1; foreach ($jadwal as $j): ?>
            <tr>
              ...
              <td>
                <a href="<?= base_url('admin/jadwalujian/edit/' . $j['id_jadwal']) ?>" class="btn btn-sm btn-warning">Edit</a>
                <form action="<?= base_url('admin/jadwalujian/delete/' . $j['id_jadwal']) ?>" method="post" style="display:inline;" onsubmit="return confirm('Yakin hapus data ini?');">
                  <?= csrf_field() ?>
