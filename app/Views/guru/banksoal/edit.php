...
<div class="d-flex guru-edit-wrapper">
  ...
  <div class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="guru-edit-container shadow">
      ...
      <form action="<?= base_url('/guru/banksoal/update/' . $bank['id_bank']) ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>
        ...
        <a href="<?= base_url('/guru/banksoal') ?>" class="btn btn-secondary ms-2">Batal</a>
      </form>
    </div>
  </div>
</div>
