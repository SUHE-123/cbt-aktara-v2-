...
<div class="d-flex soal-wrapper">
  ...
  <div class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="flex-grow-1 soal-content shadow">
      <a href="<?= base_url('/guru/banksoal') ?>" class="btn btn-success mb-3">← Kembali ke Bank Soal</a>
              ...
              <?php $no = 1; foreach ($soal as $s): ?>
                <tr>
                  ...
                  <td class="text-nowrap text-center">
                    <form action="<?= base_url('guru/soal/delete/' . $s['id_soal']) ?>" method="post" style="display:inline;" onsubmit="return confirm('Yakin ingin menghapus soal ini?');">
                      <?= csrf_field() ?>
