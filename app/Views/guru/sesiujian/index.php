...
<div class="d-flex sekolah-index-wrapper">
  ...
  <div class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="flex-grow-1 sekolah-index-content shadow">
      <a href="<?= base_url('/guru/sesiujian/create') ?>" class="btn btn-primary mb-3">
        ...
        <tbody>
          <?php $no = 1; foreach ($sesi as $row): ?>
            <tr>
              ...
              <td>
                <a href="<?= base_url('/guru/sesiujian/edit/' . $row['id_sesi']) ?>" class="btn btn-sm btn-warning">Edit</a>
                <form action="<?= base_url('/guru/sesiujian/delete/' . $row['id_sesi']) ?>" method="post" style="display:inline;" onsubmit="return confirm('Yakin ingin menghapus sesi ini?');">
                  <?= csrf_field() ?>
