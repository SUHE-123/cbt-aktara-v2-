...
<div class="d-flex sekolah-index-wrapper">
  ...
  <div class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="flex-grow-1 sekolah-index-content shadow">
      <a href="<?= base_url('/guru/nomorpeserta/create') ?>" class="btn btn-primary mb-3">
          ...
          <tbody>
            <?php $no = 1; foreach($peserta as $p): ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url('/guru/nomorpeserta/edit/' . $p['id_peserta']) ?>" class="btn btn-sm btn-warning">Edit</a>
                  <form action="<?= base_url('/guru/nomorpeserta/delete/' . $p['id_peserta']) ?>" method="post" style="display:inline;" onsubmit="return confirm('Yakin ingin menghapus?');">
                    <?= csrf_field() ?>
