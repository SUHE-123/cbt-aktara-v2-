...
<div class="d-flex kb-edit-wrapper">
  ...
  <div class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="container kb-container shadow">
      <form action="<?= base_url('/guru/koleksibuku/update/'.$buku['id_buku']) ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>
        ...
        <a href="<?= base_url('/guru/koleksibuku') ?>" class="btn btn-secondary ms-2">Batal</a>
      </form>
    </div>
  </div>
</div>
