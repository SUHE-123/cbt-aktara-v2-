...
<div class="d-flex kb-form-wrapper">
  ...
  <div class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="container kb-container shadow">
      <form action="<?= base_url('/guru/koleksibuku/store') ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>
        ...
        <a href="<?= base_url('/guru/koleksibuku') ?>" class="btn btn-secondary ms-2">Kembali</a>
      </form>
    </div>
  </div>
</div>
