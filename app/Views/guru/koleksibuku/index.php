...
<div class="d-flex kb-index-wrapper">
  ...
  <div class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="flex-grow-1 kb-content shadow-sm">
      <a href="<?= base_url('/guru/koleksibuku/create') ?>" class="btn btn-primary mb-3"><i class="bi bi-plus-lg"></i> Tambah Buku</a>
        ...
        <table id="bukuTable" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="<?= base_url('guru/koleksibuku/edit/'.$b['id_buku']) ?>" class="btn btn-sm btn-warning mb-1">Edit</a>
                <form action="<?= base_url('guru/koleksibuku/delete/'.$b['id_buku']) ?>" method="post" style="display:inline" onsubmit="return confirm('Hapus buku?');">
                  <?= csrf_field() ?>
