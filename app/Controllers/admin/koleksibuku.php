...
class KoleksiBuku extends BaseController
{
    ...
    public function index()
    {
        $data['koleksi'] = $this->bukuModel
            ...
            ->findAll();
        return view('admin/koleksibuku/index', $data);
    }

    public function create()
    {
        $data['jenis'] = $this->jenisModel->findAll();
        return view('admin/koleksibuku/create', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $data['jenis'] = $this->jenisModel->findAll();
        return view('admin/koleksibuku/edit', $data);
    }
    ...
    public function update($id)
{
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/admin/koleksibuku')->with('success', 'Koleksi buku berhasil dihapus.');
    }
}
