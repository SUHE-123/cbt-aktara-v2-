...
class jadwalujian extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin/jadwalujian/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin/jadwalujian/create', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/admin/jadwalujian')->with('success', 'Jadwal ujian berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/jadwalujian/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/admin/jadwalujian')->with('success', 'Jadwal ujian berhasil diperbarui.');
    }

    public function delete($id)
    {
        $this->jadwalModel->delete($id);
        return redirect()->to('/admin/jadwalujian')->with('success', 'Jadwal ujian berhasil dihapus.');
    }
}
