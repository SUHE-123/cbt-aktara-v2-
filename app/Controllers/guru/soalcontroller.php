...
class soalcontroller extends BaseController
{
    ...
    public function create($id_bank)
    {
        ...
        return view('guru/soal/create', $data);
    }
        ...
        public function store($id_bank)
    {
        ...
        return redirect()->to("/guru/soal/{$id_bank}")->with('success', 'Soal berhasil ditambahkan.');
    }
    ...
    public function edit($id_soal)
    {
        ...
        return view('guru/soal/edit', $data);
    }
    ...
    public function update($id_soal)
    {
        ...
        return redirect()->to("/guru/soal/{$soal['id_bank']}")->with('success', 'Soal berhasil diperbarui.');
    }
    ...
    public function delete($id_soal)
    {
        ...
        return redirect()->to("/guru/soal/{$id_bank}")->with('success', 'Soal berhasil dihapus.');
    }
}
