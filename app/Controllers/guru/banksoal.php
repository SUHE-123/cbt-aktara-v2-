...
class BankSoal extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('guru/banksoal/index', $data);
    }

    public function create()
    {
        $data['mapel'] = $this->mapelModel->findAll();
        return view('guru/banksoal/create', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/guru/banksoal')->with('success', 'Bank soal dan data soal berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('guru/banksoal/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/guru/banksoal')->with('success', 'Data bank soal dan soal berhasil diperbarui.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/guru/banksoal')->with('success', 'Bank soal dan soal terkait berhasil dihapus.');
    }
}
