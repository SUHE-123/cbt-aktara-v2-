...
class jenisujian extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('guru/jenisujian/index', $data);
    }

    public function create()
    {
        return view('guru/jenisujian/create');
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/guru/jenisujian')->with('success', 'Jenis ujian berhasil ditambahkan.');
    }

    public function edit($id)
    {
        $data['jenis'] = $this->jenisModel->find($id);
        return view('guru/jenisujian/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/guru/jenisujian')->with('success', 'Jenis ujian berhasil diperbarui.');
    }

    public function delete($id)
    {
        $this->jenisModel->delete($id);
        return redirect()->to('/guru/jenisujian')->with('success', 'Jenis ujian berhasil dihapus.');
    }
}
