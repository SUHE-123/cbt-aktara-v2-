...
class alokasiwaktucontroller extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('guru/alokasiwaktu/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('guru/alokasiwaktu/create', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/guru/alokasiwaktu')->with('success', 'Alokasi waktu berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$alokasi) {
            return redirect()->to('/guru/alokasiwaktu')->with('error', 'Data tidak ditemukan.');
        }
        ...
        return view('guru/alokasiwaktu/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/guru/alokasiwaktu')->with('success', 'Alokasi waktu berhasil diperbarui.');
    }

    public function delete($id)
    {
        $this->alokasiModel->delete($id);
        return redirect()->to('/guru/alokasiwaktu')->with('success', 'Alokasi waktu berhasil dihapus.');
    }
}
