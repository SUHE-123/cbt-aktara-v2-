...
class Siswa extends BaseController
{
    ...
    public function store()
    {
        ...
        return redirect()->to('/guru/siswa')->with('success', 'Siswa berhasil ditambahkan.');
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/guru/siswa')->with('success', 'Data siswa berhasil diubah.');
    }

    public function delete($id)
    {
        $this->siswaModel->delete($id);
        return redirect()->to('/guru/siswa')->with('success', 'Siswa berhasil dihapus.');
    }
}
